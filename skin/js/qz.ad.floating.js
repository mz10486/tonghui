...
$(function() {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        strHtml += "<img src='../../plugin/ad/close.png'/*tpa=http://www.thansacn.com/plugin/ad/close.png*/ style='position:absolute;top:5px;right:5px;cursor:pointer;' onclick='$(this).parent().remove()' alt='关闭' />";
        strHtml += "</div>";
